...
<div class="w3-main" style="margin-left:300px; padding: 0 3px">
  ...
  <div id="content" class="border border-2 p-3 bg-white">
    ...
    <div class="row">
      <div class="col-8">
        <ul class="pagination">
          <li class="page-item"><a class="page-link text-black" href="<?php echo baseUrl() . "/transaksiPengembalian/formulirPengembalianBuku"; ?>">Formulir Pengembalian Buku</a></li>
          <li class="page-item"><a class="page-link text-white active" href="<?php echo baseUrl() . "/transaksiPengembalian/riwayatPengembalianBuku"; ?>">Riwayat Pengembalian Buku</a></li>
        </ul>
      </div>
...
<?php } ?>
      ...
      <div class="d-flex justify-content-between align-items-center mt-4">
        <a href="http://localhost/perpus/laporan/riwayatPengembalian"><p class="text-sm-start text-light-50 btn btn-secondary" style="color:white"><i class="fa-solid fa-print"></i> Laporan Ke PDF</p></a> 
        <nav aria-label="...">
          <ul class="pagination">
<?php if ( $data["hf"] > 1 ) { ?>
            <li class="page-item">
              <a class="page-link text-black-50" href="<?php echo baseUrl().'/transaksiPengembalian/riwayatPengembalianBuku/page='. $data['hf']-1; ?>">Sebelumnya</a>
            </li>
<?php } ?>
<?php for ( $i = $data["na"]; $i <= $data["nr"]; $i++ ) { ?>
            ...
            " aria-current="page">
              <a class="page-link text-black-50" href="<?php echo baseUrl().'/transaksiPengembalian/riwayatPengembalianBuku/page='. $i; ?>"><?php echo $i; ?></a>
            </li>
<?php } ?>
<?php if ( $data["hf"] < $data["jp"] ) { ?>
            <li class="page-item">
              <a class="page-link text-black-50" href="<?php echo baseUrl().'/transaksiPengembalian/riwayatPengembalianBuku/page='. $data['hf']+1; ?>">Selanjutnya</a>
            </li>
<?php } ?>
          </ul>
      </nav>
