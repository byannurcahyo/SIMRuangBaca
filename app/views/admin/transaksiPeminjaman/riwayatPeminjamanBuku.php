...
<?php } ?>
      ...
      <!-- <div class="d-flex justify-content-between align-items-center mt-4">
        <a href="http://localhost/perpus/laporan/riwayatPeminjaman"><p class="text-sm-start text-light-50 btn btn-secondary" style="color:white"><i class="fa-solid fa-print"></i> Laporan Ke PDF</p></a>
        <nav aria-label="...">
          <ul class="pagination">
            <?php if ( $data["hf"] > 1 ) { ?>
              <li class="page-item">
                <a class="page-link text-black-50" href="<?php echo baseUrl().'/transaksiPeminjaman/riwayatPeminjamanBuku/page='. $data['hf']-1; ?>">Sebelumnya</a>
              </li>
            <?php } ?>
            <?php for ( $i = $data["na"]; $i <= $data["nr"]; $i++ ) { ?>
              <li class="page-item
                ...
                " aria-current="page">
                <a class="page-link text-black-50" href="<?php echo baseUrl().'/transaksiPeminjaman/riwayatPeminjamanBuku/page='. $i; ?>"><?php echo $i; ?></a>
              </li>
            <?php } ?>
            <?php if ( $data["hf"] < $data["jp"] ) { ?>
              <li class="page-item">
                <a class="page-link text-black-50" href="<?php echo baseUrl().'/transaksiPeminjaman/riwayatPeminjamanBuku/page='. $data['hf']+1; ?>">Selanjutnya</a>
              </li>
            <?php } ?>
          </ul>
        </nav>
