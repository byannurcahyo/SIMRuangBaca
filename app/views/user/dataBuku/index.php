  ...
  <form acction="" method="post">  
    <p class=" d-flex" style="width: 290px;">
      ...
      <select id="tamp" class="form-select form-select-sm w-30 mb-3 mx-2" aria-label=".form-select-lg example" name="jenisBuku">
        ...
        <option <?php echo (isset($_SESSION["jenisBuku"]) && $_SESSION["jenisBuku"] == "Artikel" )? "selected":"" ;?>>Artikel</option>
        <option <?php echo (isset($_SESSION["jenisBuku"]) && $_SESSION["jenisBuku"] == "Disertasi")? "selected":"" ;?>>Disertasi</option>
        <option <?php echo (isset($_SESSION["jenisBuku"]) && $_SESSION["jenisBuku"] == "Ensiklopedia")? "selected":"" ;?>>Ensiklopedia</option>
        <option <?php echo (isset($_SESSION["jenisBuku"]) && $_SESSION["jenisBuku"] == "Jurnal")? "selected":"" ;?>>Jurnal</option>
        <option <?php echo (isset($_SESSION["jenisBuku"]) && $_SESSION["jenisBuku"] == "Novel")? "selected":"" ;?>>Novel</option>
        <option <?php echo (isset($_SESSION["jenisBuku"]) && $_SESSION["jenisBuku"] == "Panduan")? "selected":"" ;?>>Non-Fiksi</option>
        <option <?php echo (isset($_SESSION["jenisBuku"]) && $_SESSION["jenisBuku"] == "Penelitian")? "selected":"" ;?>>Penelitian</option>
        <option <?php echo (isset($_SESSION["jenisBuku"]) && $_SESSION["jenisBuku"] == "Skripsi")? "selected":"" ;?>>Skripsi</option>
        <option <?php echo (isset($_SESSION["jenisBuku"]) && $_SESSION["jenisBuku"] == "Tesis")? "selected":"" ;?>>Tesis</option>
      </select> 
    </p>
