...
<body class="w3-light-grey">
  ...
  <div class="w3-bar w3-top w3-black w3-large" style="z-index:4">
    <button class="w3-bar-item w3-button w3-hide-large w3-hover-none w3-hover-text-light-grey" onclick="w3_open();"><i class="fa fa-bars"></i>  Menu</button> 
      ...
      <a href="<?php echo baseUrl() . '/dashboard/index'; ?>"><span class="w3-bar-item w3-left"><img src="<?php echo baseUrl() . '/assets/img/logo.png';  ?>" class="" width="30px" height="30px">   E-perpus</span></a>
  ...
  <nav class="w3-sidebar w3-collapse w3-animate-left" style="z-index:3;width:300px;background-color: #18dd18;" id="mySidebar"><br>
    ...
    <div class="w3-bar-block">
      ...
      <a href="<?php echo baseUrl() . "/transaksiPeminjaman/formulirPeminjamanBuku"; ?>" class="w3-bar-item w3-button w3-padding <?php echo pilihan($data['pilihan'],'transaksiPeminjaman'); ?>"><i class="fa fa-sign-out fa-fw"></i> Transaksi Peminjaman</a>
      <a href="<?php echo baseUrl() . "/transaksiPengembalian/riwayatPengembalianBuku" ?>" class="w3-bar-item w3-button w3-padding <?php echo pilihan($data['pilihan'],'transaksiPengembalian'); ?>"><i class="fa fa-sign-in fa-fw"></i> Transaksi Pegembalian</a>
      ...
      <?php if ( isset($_SESSION["isiPesanUser"]) ) { ?>

        <span class="badge text-bg-danger"><?php echo $_SESSION["isiPesanUser"]; ?></span> 
