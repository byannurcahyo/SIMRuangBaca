...
class app {
	...
	public function __construct () {
		...
		// 	} else {
		// 		// Jika method tidak ditemukan, atur ke metode default yang diinginkan
		// 		$this->method = "defaultMethod"; // Ganti dengan nama metode default yang diinginkan
		// 	}
		// } else {
		// 	// Atur metode default jika tidak ada metode yang diberikan dalam URL
		// 	$this->method = "defaultMethod"; // Ganti dengan nama metode default yang diinginkan
		}
